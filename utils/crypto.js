...
const AUTH_SALT = new TextEncoder().encode('calcnotes:auth-key-salt:v1')
const ENC_SALT = new TextEncoder().encode('calcnotes:enc-key-salt:v1')
const SHARE_SALT = new TextEncoder().encode('calcnotes:share-key-salt:v1')
