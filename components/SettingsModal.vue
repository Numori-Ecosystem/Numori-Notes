<template>
  <Teleport to="body">
    <Transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0"
      ...
      <div v-if="isOpen"
        class="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4 bg-black bg-opacity-50"
        @click="closeModal">
        <Transition enter-active-class="transition ease-out duration-300"
          ...
          <div v-if="isOpen" @click.stop
            class="bg-white dark:bg-gray-925 rounded-t-xl md:rounded-lg max-w-5xl w-full h-[95vh] md:h-[90vh] overflow-hidden flex flex-col">
            <!-- Header -->
            <div
